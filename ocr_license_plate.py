...
anpr = PyImageSearchANPR(3,5,debug=args["debug"]>0)
...
# load the input image from disk and resize it
    ...
    if lpText is not None and lpCnt is not None:
        # fit a rotated boundign box to the license plate contour draw the bounding box on the license plate
        ...
        cv2.putText(image, cleanup_text(lpText), (x,y-15), cv2.FONT_HERSHEY_COMPLEX, 0.75, (0,255,0), 2)
